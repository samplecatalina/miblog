...
export default function Post({ post }) {
    ...
    return (
        <div>
            <h1 className='text-sky-400 text-5xl mt-4 font-semibold tracing-wide'>{post.title}</h1>
            {coverImage && <img src={coverImage} className='mt4' />}

            <p className='text-sky-400 text-sm font-light my-4'>By {post.username}</p>
            <div className='mt-8'>
                <ReactMarkDown className='text-sky-400 prose' children={post.content} />
            </div>
